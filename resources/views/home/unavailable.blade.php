...
<div class="show-noti-unavailable">
    <div class="unavailable-wrapper">
        <div class="unavailable-header">Phòng đã hết</div>
        
        <div class="unavailable-icon-wrap">
            <div class="unavailable-icon">
                <div class="unavailable-handle"></div>
            </div>
        </div>
        
        <h1 class="unavailable-title">Phòng mà quý khách chọn hiện không còn trống</h1>
        <p class="unavailable-message">
            Rất tiếc, phòng này đã được đặt bởi khách hàng khác. <br>
            Vui lòng chọn phòng khác hoặc thay đổi thời gian để tiếp tục đặt phòng.
        </p>
        
        <button class="unavailable-btn" onclick="window.history.back();">
            Tìm kiếm phòng khác
        </button>
    </div>
</div>
