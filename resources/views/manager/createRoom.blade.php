        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="main-body">
                <div class="room-create-form">
                    ...
                    <form id="roomCreateForm" action="{{route('manager.rooms.add')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="room_name">Tên phòng</label>
                            <input type="text" id="room_name" name="room_name" class="form-control">
                            <div class="room-create-error" id="room_name_error"></div>
                        </div>

                        <div class="form-group">
                            <label for="type">Loại phòng</label>
                            <select id="type" name="room_type" class="form-control">
                                <option value="">Chọn loại phòng</option>
                                <option value="standard">Standard</option>
                                <option value="deluxe">Deluxe</option>
                                <option value="family">Family</option>
                            </select>
                            <div class="room-create-error" id="type_error"></div>
                        </div>

                        <div class="form-group">
                            <label for="price">Giá (VNĐ/đêm)</label>
                            <input type="number" id="price" name="price" class="form-control">
                            <div class="room-create-error" id="price_error"></div>
                        </div>

                        <div class="form-group">
                            <label for="capacity">Sức chứa tối đa</label>
                            <input type="number" id="capacity" name="capacity" class="form-control">
                            <div class="room-create-error" id="capacity_error"></div>
                        </div>

                        <div class="form-group">
                            <label for="description">Mô tả</label>
                            <textarea id="description" name="description" class="form-control" placeholder="Nhập mô tả chi tiết về phòng..."></textarea>
                            <div class="room-create-error" id="description_error"></div>
                        </div>

                        <div class="form-group">
                            <label for="images">Ảnh phòng</label>
                            <input type="file" id="room_image" name="room_image[]" class="form-control-file" multiple accept="image/*">

                            <div class="room-create-error" id="images_error"></div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                // Reset lỗi cũ
                document.querySelectorAll('.room-create-error').forEach(el => el.innerText = '');
                ...
                //     descriptionError.innerText = 'Mô tả không được để trống';
                //     description.classList.add('error');
                //     hasError = true;
                // }

                // Validate ảnh (optional - có thể bỏ qua nếu không bắt buộc)
                const images = document.getElementById('images');
                const imagesError = document.getElementById('images_error');
                if (images.files.length === 0) {
                    imagesError.innerText = 'Vui lòng chọn ít nhất 1 ảnh';
                    hasError = true;
                }
