...
/* CSS cho div content-card khi không có dữ liệu */
.content-card {
    background: #f8f9fa;
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{route('manager.showPayment')}}" class="menu-item active ">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$payment->booking->guest_phone}}</td>
                            <td>{{$payment->booking->guest_email}}</td>
                        </tr>
                        @endforeach
                        @if($payments->isEmpty())
                        <tr>
                            <td>
                                <div class="content-card">
                                    ...
                                    <p>Hiện tại không có thông tin thanh toán nào.</p>
                                </div>
                            </td>
                        </tr>
                        @endif
