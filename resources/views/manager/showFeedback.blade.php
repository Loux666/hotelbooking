        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{route('manager.showFeedback')}}" class="menu-item active">
            ...
            <div class="main-body">
                @foreach ($bookings as $booking)
                    @foreach ($booking->booking_details as $detail)
                        @php
                            $detailFeedbacks = $feedbacksByDetail[$detail->id] ?? collect();
                        @endphp
                        
                        @if ($detailFeedbacks->isNotEmpty())
                            <div class="feedback-card">
                                <!-- Bên trái: Feedback và rating -->
                                <div class="feedback-section">
                                    <div class="guest-info">
                                        <div class="guest-name">{{ $booking->guest_name }}</div>
                                        <div class="guest-details">
                                            <div>Email: {{ $booking->guest_email }}</div>
                                            <div>SĐT: {{ $booking->guest_phone }}</div>
                                        </div>
                                    </div>
                                    
                                    <div class="feedback-title"></div>
                                    @foreach ($detailFeedbacks as $feedback)
                                        <div class="feedback-item">
                                            ...
                                            <div class="feedback-date">{{ $feedback->created_at->format('d/m/Y H:i') }}</div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="room-section">
                                    <div class="room-info">
                                        <div class="room-name">{{ $detail->room->room_name ?? '[Phòng đã xóa]' }}</div>
                                        <div class="room-dates">
                                            Từ {{ $detail->checkin }} đến {{ $detail->checkout }}
                                        </div>
                                        
                                        @if ($detail->room && $detail->room->images->isNotEmpty())
                                            <img src="{{ asset('roomImg/' . $detail->room->images->first()->image_path) }}"
                                                alt="Ảnh phòng" class="room-image">
                                        @endif
                                    </div>
                                </div>
                            </div>
